...
function aya_theme_frontend_translations_map()
{
    $translations = [
        ...
        'start_feedback' => __('发起反馈', 'aiya-cms'),
        'create_feedback' => __('创建反馈', 'aiya-cms'),
        'manual_input' => __('手动输入', 'aiya-cms'),
        'create_feedback_description' => __('发起一个当前文章的反馈，内容勘误或要求更新。', 'aiya-cms'),
        ...
        // issues.tsx
        'issue' => __('议题', 'aiya-cms'),
        'discussion' => __('讨论', 'aiya-cms'),
        'question' => __('问题', 'aiya-cms'),
        ...
        'issue_content' => __('议题说明（可选）', 'aiya-cms'),
        'issue_title_placeholder' => __('请输入议题标题', 'aiya-cms'),
        'issue_content_placeholder' => __('请描述你想讨论的问题或想法', 'aiya-cms'),
        'issue_type_placeholder' => __('请选择议题类型', 'aiya-cms'),
        'issue_title_required' => __('议题标题不能为空', 'aiya-cms'),
        'issue_content_required' => __('议题内容不能为空', 'aiya-cms'),
        'issue_created' => __('议题已创建', 'aiya-cms'),
        'submit_issue_failed' => __('提交议题失败', 'aiya-cms'),
        'api_endpoint_not_configured' => __('接口地址未配置', 'aiya-cms'),
        'unknown_time' => __('未知时间', 'aiya-cms'),
        'issue_type_issue' => __('提议', 'aiya-cms'),
        'issue_type_discussion' => __('讨论', 'aiya-cms'),
        'issue_type_question' => __('提问', 'aiya-cms'),
        'issue_type_feedback' => __('问题反馈', 'aiya-cms'),
        'issue_status_open' => __('打开', 'aiya-cms'),
        'issue_status_closed' => __('已关闭', 'aiya-cms'),
        'issue_status_accepted' => __('已接受', 'aiya-cms'),
        'issue_status_progress' => __('进行中', 'aiya-cms'),
        'issue_status_resolved' => __('已解决', 'aiya-cms'),
        'issue_status_pending' => __('待处理', 'aiya-cms'),
        'issue_list_load_failed' => __('议题列表加载失败', 'aiya-cms'),
        'retry' => __('重试', 'aiya-cms'),
        'issue_empty_title' => __('当前筛选下还没有议题', 'aiya-cms'),
        'issue_empty_description' => __('可以切换筛选条件，或从顶部操作卡片中直接新建议题。', 'aiya-cms'),
        'no_description' => __('无描述', 'aiya-cms'),
        'initiated_on' => __('发起在：', 'aiya-cms'),
        'created_at' => __('创建于', 'aiya-cms'),
        'issue_detail_load_failed' => __('议题详情加载失败', 'aiya-cms'),
        'issue_reply_list_load_failed' => __('回复列表加载失败', 'aiya-cms'),
        'issue_reply_content_required' => __('请回复内容不能为空', 'aiya-cms'),
        'issue_reply_published' => __('回复已发布', 'aiya-cms'),
        'issue_reply_send_failed' => __('发送回复失败', 'aiya-cms'),
        'issue_not_found' => __('议题不存在', 'aiya-cms'),
        'return_to_list_continue' => __('返回列表以继续操作。', 'aiya-cms'),
        'issue_body_empty' => __('暂无正文内容', 'aiya-cms'),
        'issue_reply_count_suffix' => __('条回复', 'aiya-cms'),
        'anonymous_user' => __('匿名用户', 'aiya-cms'),
        'published_at' => __('发布于', 'aiya-cms'),
        'replied_at' => __('回复于', 'aiya-cms'),
        'issue_no_one_has_responded' => __('还没有人回应。', 'aiya-cms'),
        'last_active_at' => __('最后活动于', 'aiya-cms'),
        'reply_issue' => __('回复议题', 'aiya-cms'),
        'add_reply' => __('添加回复', 'aiya-cms'),
        'sending' => __('发送中...', 'aiya-cms'),
        'issue_form_title' => __('创建/编辑议题', 'aiya-cms'),
        'issue_form_description' => __('创建或编辑一个议题讨论，分享你的想法和建议。（如果需要对站内某一帖子发起讨论，请在帖子底部通过“发起反馈”按钮以创建讨论关联）', 'aiya-cms'),
        'issue_title_brief_placeholder' => __('简要描述这个议题', 'aiya-cms'),
        'issue_form_type_label' => __('类型', 'aiya-cms'),
        'issue_body_label' => __('正文', 'aiya-cms'),
        'issue_body_placeholder' => __('详细描述这个议题，此输入框支持 Markdown 或简单 HTML', 'aiya-cms'),
        'issue_save_failed' => __('议题保存失败', 'aiya-cms'),
        'issue_updated' => __('议题已更新', 'aiya-cms'),
        'issue_not_found_or_inaccessible' => __('议题不存在或无法访问', 'aiya-cms'),
        'issue_not_found_message' => __('没有找到对应议题。', 'aiya-cms'),
        'return_to_list' => __('返回列表', 'aiya-cms'),
        'no_edit_permission' => __('没有编辑权限', 'aiya-cms'),
        'cannot_edit_issue' => __('当前登录用户无法编辑这个议题。', 'aiya-cms'),
        'return' => __('返回', 'aiya-cms'),
        'save_changes' => __('保存修改', 'aiya-cms'),
        'sort_created_at' => __('创建时间', 'aiya-cms'),
        'sort_comment_count' => __('评论数', 'aiya-cms'),
        'sort_updated_at' => __('最后更新', 'aiya-cms'),
        'sort_desc' => __('倒序', 'aiya-cms'),
        'sort_asc' => __('正序', 'aiya-cms'),
        'status_updated_to_s' => __('状态已更新为 %s', 'aiya-cms'),
        'issue_status_updated_to_s' => __('议题状态已更新为 %s', 'aiya-cms'),
        'status_update_failed' => __('状态更新失败', 'aiya-cms'),
        'confirm_delete_issue_s' => __('确认删除议题「%s」吗？', 'aiya-cms'),
        'issue_deleted' => __('议题已删除', 'aiya-cms'),
        'issue_delete_failed' => __('议题删除失败', 'aiya-cms'),
        'filter_status' => __('筛选状态', 'aiya-cms'),
        'all_statuses' => __('全部状态', 'aiya-cms'),
        'filter_type' => __('筛选类型', 'aiya-cms'),
        'all_categories' => __('全部分类', 'aiya-cms'),
        'sort_field' => __('排序字段', 'aiya-cms'),
        'sort_order' => __('排序方向', 'aiya-cms'),
        'issues_count_d' => __('%d 个议题', 'aiya-cms'),
        'issue_home' => __('议题首页', 'aiya-cms'),
        'back_to_issue' => __('返回议题', 'aiya-cms'),
        'select_issue_status' => __('选择议题状态', 'aiya-cms'),
        'delete_issue' => __('删除议题', 'aiya-cms'),
        'issue_edit_mode_hint' => __('编辑模式，点击返回议题以退出编辑', 'aiya-cms'),
        // comment.tsx
        'name' => __('名称', 'aiya-cms'),
