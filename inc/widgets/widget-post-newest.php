...
class AYA_Widget_Post_Newest extends AYA_Widget
{
    function widget_args()
    {
        $widget_args = [
            ...
            'title' => __('AIYA-CMS 最新文章', 'aiya-cms'),
            'classname' => 'widget-panel',
            'desc' => __('文章列表卡片，展示最近发布的文章', 'aiya-cms'),
            'field_build' => [
                [
                    'type' => 'input',
                    'id' => 'title',
                    'name' => __('标题', 'aiya-cms'),
                    'default' => __('最新文章', 'aiya-cms'),
                ],
                [
                    'type' => 'input',
                    'id' => 'limit',
    ...
    function widget_func()
    {
        ...
        $query_posts = $query_obj->get_posts([], $limit);
        $posts_data = [];
        ...
        aya_react_island(
            'widget-post',
            ['posts' => $posts_data, 'widgetTitle' => $title, 'postType' => 'newest']
        );
    }
}
