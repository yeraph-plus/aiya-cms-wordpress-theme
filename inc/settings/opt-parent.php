...
AYF::new_opt([
    ...
    'fields' => [
        ...
        [
            'title' => '内容为空占位图',
            'desc' => '上传分类、搜索、作者等文章列表为空的占位图',
            'id' => 'site_none_content_upload',
            'type' => 'upload',
            'button_text' => '上传',
            'default'  => AYA_URI . '/assets/image/default-none-content.png',
        ],
        [
            'title' => ' 404 页面占位图',
        ...
        [
            'title' => ' 501 页面占位图',
            'desc' => '上传 501 页面卡片的占位图片',
            'id' => 'site_501_page_img_upload',
            'type' => 'upload',
            'button_text' => '上传',
            'default'  => AYA_URI . '/assets/image/default-501-error.png',
        ],
        [
            'desc' => '合规类功能设置',
            'type' => 'title_1',
