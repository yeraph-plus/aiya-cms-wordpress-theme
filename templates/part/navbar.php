<aside
    class="flex flex-col h-full p-3 w-[var(--navbar-full-width)] bg-gray-50 dark:bg-gray-900 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 text-gray-800 dark:text-gray-100">
    <div class="space-y-3">
        <div class="flex items-center justify-between">
            <h2>Dashboard</h2>
            <button class="p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                    class="w-5 h-5 fill-current text-gray-800 dark:text-gray-100 text-gray-800 dark:text-gray-100">
        ...
        <div class="relative">
            <span class="absolute inset-y-0 left-0 flex items-center py-4">
                <button type="submit" class="p-2 focus:outline-none focus:ring">
                    <svg fill="currentColor" viewBox="0 0 512 512"
                        class="w-5 h-5 text-gray-600 dark:text-gray-400 text-gray-600 dark:text-gray-400">
                        <path
            ...
            <input type="search" name="Search" placeholder="Search..."
                class="w-full py-2 pl-10 text-sm border-transparent dark:border- dark:border- rounded-md focus:outline-none bg-gray-100 dark:bg-gray-800 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 text-gray-800 dark:text-gray-100 focus:bg-gray-50 focus:dark:bg-gray-900 focus:bg-gray-50 focus:dark:bg-gray-900">
        </div>
        <div class="flex-1">
            <ul class="pt-2 pb-4 space-y-1 text-sm">
                <li class="rounded-sm">
                    <a rel="noopener noreferrer" href="#" class="flex items-center p-2 space-x-3 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            class="w-5 h-5 fill-current text-gray-600 dark:text-gray-400 text-gray-600 dark:text-gray-400">
                            <path
                ...
                <li
                    class="rounded-sm bg-gray-100 dark:bg-gray-800 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-50 text-gray-900 dark:text-gray-50">
                    <a rel="noopener noreferrer" href="#" class="flex items-center p-2 space-x-3 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            class="w-5 h-5 fill-current text-gray-600 dark:text-gray-400 text-gray-600 dark:text-gray-400">
                            <path
...
<!-- 主要内容区域 -->
<div class="flex flex-col flex-1" :class="isSidebarOpen ? 'ml-64' : 'ml-16'">
    <!-- 顶部导航栏 -->
    <header class="bg-white shadow-sm fixed w-full top-0 z-40" :class="isSidebarOpen ? 'ml-64' : 'ml-16'">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <button class="flex items-center focus:outline-none">
                        <span class="w-8 h-8 bg-gray-400 rounded-full"></span>
                    </button>
                </div>
            </div>
        </div>
