                ...
                <div class="layout w-full lg:w-4/5">
                    ...
                    <main data-pjax-container="main">
                        ...
                        if (count($breadcrumb_items) > 1) {
                            $breadcrumb_props = ['items' => $breadcrumb_items];
                            $server_html = aya_island_render_nav_breadcrumb($breadcrumb_props);
                            aya_react_island('nav-breadcrumb', $breadcrumb_props, $server_html, true);
                        }
                        ?>