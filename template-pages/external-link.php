...
?>
<div class="external-link w-full p-4">
                    ...
                    <?php if ($checked === true): ?>
                        ...
                        <p class="m-10 flex items-center justify-center font-normal text-base">
                            <a href="<?php aya_echo($external_url); ?>" class="btn btn-primary underline mx-1 text-primary flex items-center justify-center" target="_blank">
                                <i data-feather="external-link" width="16" height="16" class="animate-spin mr-2"></i>
                                <?php aya_echo($external_url); ?>
                            </a>
                        </p>
                    <?php else: ?>
                        <p class="m-5 flex font-semibold text-base !text-red-500">
                            <?php aya_echo(__('当前页面是是通过外部来源打开的，内容和安全性不在本站控制范围内。', 'AIYA')); ?>
                        </p>
                        <p class="m-10 flex items-center justify-center font-normal text-base">
